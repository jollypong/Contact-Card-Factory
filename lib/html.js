...
<body>
    ...
    <main>
    <section id="infoContainer" class="col-12">
...
function generateCard(team) {
    let cards = team.map(card => {
        console.log(team)
        return `
        <div id="memberCards" class="card border border-1 border-primary m-2" style = "width: 18rem">
            ...
            <div class="card-body">
                <ul class = "list-group">
                    ...
                    <li class = "list-group-item">Email <i class="fa-solid fa-circle-envelope"></i>: <a href="mailto:${card.email}">${card.email}</a></li>
